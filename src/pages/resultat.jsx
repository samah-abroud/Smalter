...
function resultat() {
  ...
  return <div className='bg-blue-700 w-full h-full'>
    ...
    <h1 className='text-3xl font-bold text-center mt-10 text-white'> Nos résultats en chiffres</h1>


<div className="flex justify-center items-center mt-16 gap-28 ">
  {data.map((item, index) => (
    <div key={index} className="flex justify-center items-center mx-4 mb-20 ">
      <div className="bg-blue-00 w-40 h-40 rounded-lg flex justify-center items-center ">
