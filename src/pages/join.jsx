...
function join() {
  return ( 
  <div className="mt-96 flex justify-center px-4 md:px-0" id='about'>
  ...
  <p className="text-blue-600 font-semibold text-xs">__Rejoignez-nous</p>
  <h1 className="font-bold mt-6 text-3xl md:text-4xl">Enjoy your time working</h1>
